...
**! IMPORTANT !**: do not edit files in the `plugins` or `dist` folder. They are automatically generated by the build script from the source files in `src`. Edit source files only.