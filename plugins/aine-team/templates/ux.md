...
**What we're building:**
<!-- Specific description: app, feature, page, or flow -->

**Primary user:**
<!-- Who they are and what they need to accomplish -->

**Core problem:**
<!-- What's frustrating about existing solutions? What does this solve? -->

**Platform:**
<!-- Web desktop / mobile web / cross-platform / specific breakpoints -->

**Constraints:**
<!-- Brand, style, existing design system, accessibility requirements -->

**Success definition:**
<!-- What does a successful first prototype look like? -->
...
| Navigation | <!-- based on navigation decision --> | |
| <!-- add components --> | | |
