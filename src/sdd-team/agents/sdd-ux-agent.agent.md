...
5. Read `./templates/ux.md` to generate  a UX spec file that captures the key design decisions you made in the prototype, and save it to `sdd-docs/ux.md` (either as a new document or appended to existing one).
